...
async function fetchDashboardData() {
    try {
        const response = await fetch(apiPrefix + 'api.php?action=dashboard_data');
...
async function fetchLogsData() {
    try {
        const response = await fetch(apiPrefix + 'api.php?action=get_logs');
...
async function fetchUsersData() {
    try {
        const response = await fetch(apiPrefix + 'api.php?action=get_employees');
        const json = await response.json();
